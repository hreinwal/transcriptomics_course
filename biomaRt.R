...
# Have a look at those objects with View().
# You can export those again to csv with the write.csv2 function
...
?getLDS
# Q: can you use getLDS to retrieve homologues genes between h.sapiens & d.rerio?
